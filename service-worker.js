const CACHE_NAME="read-by-syllables-v7-mobile";
const APP_ASSETS=[
  ...
  "./audio/words/banany.mp3",
  "./audio/words/begemot.mp3",
  "./audio/words/belka.mp3",
  "./audio/words/cherepaha.mp3",
  "./audio/words/kniga.mp3",
  "./audio/words/korova.mp3",
  "./audio/words/koshka.mp3",
  "./audio/words/kotenok.mp3",
  "./audio/words/koza.mp3",
  "./audio/words/lisa.mp3",
  "./audio/words/luna.mp3",
  "./audio/words/malina.mp3",
  "./audio/words/mama.mp3",
  "./audio/words/mashina.mp3",
  "./audio/words/mishka.mp3",
  "./audio/words/miska.mp3",
  "./audio/words/moloko.mp3",
  "./audio/words/myshka.mp3",
  "./audio/words/noga.mp3",
  "./audio/words/papa.mp3",
  "./audio/words/raduga.mp3",
  "./audio/words/rozy.mp3",
  "./audio/words/ruka.mp3",
  "./audio/words/ryba.mp3",
  "./audio/words/sobaka.mp3",
  "./audio/words/sova.mp3",
  "./audio/words/utka.mp3",
  "./audio/words/voda.mp3",
  "./audio/words/vorona.mp3",
  "./audio/words/zaika.mp3",
  "./data.js",
